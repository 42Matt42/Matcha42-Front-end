...
module.exports = {
  addView: async(req, res, payload) => {
    ...
    try {
      ...
      await updateFieldUser('score', user_visited[0].score + 5, user_visited[0].id);
    } catch (error) {
  ...
  addReport: async(req, res, payload) => {
    ...
    try {
      ...
      await updateFieldUser('score', user_reported.score - 10, user_reported.id);
    } catch (error) {
      return response(500, 'Internal error update score', res);
    }
  ...
  addBlock: async(req, res, payload) => {
    ...
    try {
      ...
      await updateFieldUser('score', user_blocked.score - 20, user_blocked.id);
    } catch (error) {
      return response(500, 'Internal error update score', res);
    }
